...
reported to the maintainers **privately**. Use the repository's **Security tab →
private reporting**, or the private contact channel listed in the project
[`README`](README.md). All complaints will be reviewed and investigated promptly
and fairly. All community leaders are obligated to respect the privacy and security
